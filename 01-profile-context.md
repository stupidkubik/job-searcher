...
- Локации и часовые пояса: Novi Sad (on-site); remote: Serbia, Georgia, United States, European Union
- Разрешение на работу / релокация: Serbian work permit
- Компенсация: от 1000 USD
- Дата готовности начать: immediately; активно откликаюсь
...
- Наиболее важные достижения с цифрами: поддержка ~140 материалов в месяц; ускорение сборки сложных longreads до 50%; Figma-to-CMS автоматизация экономит ~3 минуты на скриншот (15–20 на материал), то есть 10+ часов ручной работы в месяц; playable ads для 20+ рекламных платформ с аудиторией 100M+.
...
## Доказательства для откликов

| Тема вакансии | Релевантное доказательство | Метрика / результат |
|---|---|---|
| CMS / design systems | Tinkoff Journal — Frontend Web Developer | ~140 материалов в месяц; до 50% быстрее сборка сложных longreads |
| Workflow automation | Figma-to-CMS автоматизация, CMS snippets | ~3 минуты на скриншот; 10+ часов ручной работы в месяц |
| UI quality | Переиспользуемые компоненты, pre-release checklist, cross-browser QA | меньше ручной разметки и регрессий |
| Interactive ads | Playbox — Creative Developer | 20+ платформ; 100M+ аудитория |
