...
| Phase 1 — application event ledger | WP1.1–WP1.2 verified; WP1.3a prototype verified; WP1.3b shared lock started | stale writes, readers/result/projections, затем B-003 |
