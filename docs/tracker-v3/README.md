...
| Phase 1 — application event ledger | WP1.1–WP1.2 verified; WP1.3a prototype verified; WP1.3b CSV/card journal + CLI recovery | connector result/projections/event integration, затем B-003 |
