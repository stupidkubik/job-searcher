...
Статус: **закрыт** — все этапы Э0–Э10 реализованы (2026-09-07 … 2026-09-08).
Документ сохраняется как запись решений и обоснований; действующие правила
живут в [`AGENTS.md`](../AGENTS.md), [`data/operations/README.md`](../data/operations/README.md)
и [`data/operations/contract.md`](../data/operations/contract.md). Незакрытые
остатки перечислены в [`roadmap.md`](roadmap.md), а не здесь — этот файл не
переписывается задним числом.

Ниже — план в том виде, в котором он был принят 2026-09-07. Основание:
[`agent-ergonomics-analysis-2026-09-07.md`](agent-ergonomics-analysis-2026-09-07.md).
Он не заменял [`AGENTS.md`](../AGENTS.md): контракт менялся только теми
коммитами, которые перечислены в этапах.
